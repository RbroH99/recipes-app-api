...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_recipe_other_user_recipe_error(self):
        ...
        new_user = create_user(email='user2qexample.com', password='test123')
    ...
    def test_create_recipe_with_new_ingredient(self):
        ...
        payload = {
            ...
            'time_minutes': 60,
            'price': Decimal('4.30'),
            'ingredients': [{'name': 'Coliflower'}, {'name': 'Salt'}],
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
        self.assertEqual(res.status_code, status.HTTP_201_CREATED)
        recipes = Recipe.objects.filter(user=self.user)
    ...
    def test_create_recipe_with_existing_ingredient(self):
        """Test creating a recipe with an exisiting ingredient."""
    ...
    def test_clear_recipe_ingredients(self):
        """Test clearing ingredients for a recipe."""
